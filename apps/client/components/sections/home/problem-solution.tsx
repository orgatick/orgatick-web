...
export function ProblemSolutionSection() {
  ...
  return (
    <section
      id="problem"
      className="py-20 md:py-28 bg-muted/30 border-b border-border/40"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg">
            College events are operationally complex even when they look simple
            to attendees. Orgatick eliminates manual operational handoffs and
            unites the complete workflow.
          </p>
        </motion.div>
