      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-muted-foreground text-base sm:text-lg">
            Whether you are a student attendee, a fest president, a gate
            volunteer, or a university dean, Orgatick provides customized
            interfaces for your needs.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          {personas.map((item) => {
            ...
            return (
              <Card
                key={item.role}
                className="bg-card border border-border/60 p-6 rounded-2xl space-y-4 hover:border-primary/40 transition-colors shadow-sm"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`size-11 rounded-xl flex items-center justify-center ${item.color}`}
                    >
