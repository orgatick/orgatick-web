        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-border/40">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm max-w-sm leading-relaxed">
              Orgatick is the unified SaaS operating platform bringing event discovery, registration, ticketing, payments, WhatsApp communication, QR
              verification, and analytics into one seamless experience.
            </p>
