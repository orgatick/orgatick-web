...
import OrgatickLogo from "@/assets/logo/orgatick";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md transition-all">
      <div className="max-w-7xl mx-auto flex sm:h-16 h-12 items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <span className="font-heading text-xl sm:text-3xl font-bold tracking-tight text-foreground flex items-center gap-1.5">Orgatick</span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          <LinkButton href="#pricing" variant="ghost" size="sm" className="hidden sm:inline-flex text-muted-foreground hover:text-foreground">
            Sign In
          </LinkButton>
