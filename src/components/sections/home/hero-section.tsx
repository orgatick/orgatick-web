import { IconArrowRight, IconBolt, IconBrandWhatsapp, IconCheck, IconQrcode } from "@tabler/icons-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight text-foreground leading-[1.1] text-balance">
            One Platform to{" "}
            <span className="bg-linear-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Discover, Operate & Measure</span> Events.
          </h1>

          {/* Subtitle */}
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl text-balance leading-relaxed font-normal">
            Eliminate fragmented Google forms, lost payments, chaotic WhatsApp groups, and venue check-in bottlenecks. Orgatick unites the complete event
            lifecycle into one seamless SaaS workspace.
          </p>

          {/* CTAs */}
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <LinkButton href="#pricing" size="lg" variant="default" className="h-12 px-7 text-base font-semibold shadow-lg shadow-primary/25 rounded-xl group">
              <span>Launch Your Event</span>
              <IconArrowRight className="size-5 ml-2 group-hover:translate-x-1 transition-transform" />
            </LinkButton>
            <LinkButton href="#capabilities" size="lg" variant="outline" className="h-12 px-7 text-base font-medium rounded-xl border-border hover:bg-muted/60">
        ...
        <div className="mt-14 sm:mt-18 relative max-w-5xl mx-auto">
          ...
          <MockupFrame size="small" className="shadow-2xl border border-primary/20 rounded-2xl overflow-hidden bg-card">
            <Mockup type="responsive" className="bg-background/95 w-full rounded-xl border-0 p-1">
              <Image
